...
public class Ex11_AtUnit2 implements ProcessFiles.Strategy {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	new ProcessFiles(new Ex11_AtUnit2(), "class").start(args);
    	if(failures == 0)
    ...
    public void process(File cFile) {
    	...
    	for(Method m : testClass.getDeclaredMethods()) {
    		...
    		// Check to see whether @TestNote is present, and used correctly.
    		TestNote testNote;
