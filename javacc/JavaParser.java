...
public class JavaParser implements JavaParserConstants {
   ...
   public static void main(String args[]) {
          JavaParser parser;
          if (args.length == 2) {
          System.out.println("Java Code Sniffer Version 1.0: Reading from file " + args[0] + " . . .");
                  try {
                        parser = new JavaParser(new java.io.FileInputStream(args[0]));
                  } catch (java.io.FileNotFoundException e) {
                        System.out.println("Java Code Sniffer Version 1.0: File " + args[0] + " not found.");
                        return;
                  }
                  if (args[1].equalsIgnoreCase("c")) {
                        mode = OpMode.DisplayComments;
                        System.out.println("DISPLAYING COMMENTS...\u005cn");
                  } else if (args[1].equalsIgnoreCase("s")) {
                        mode = OpMode.DisplayStrings;
                        System.out.println("DISPLAYING STRING LITERALS...\u005cn");
                  } else if (args[1].equalsIgnoreCase("n")) {
                        mode = OpMode.DisplayClassNames;
                        System.out.println("DISPLAYING CLASS NAMES...\u005cn");
                  } else {
                        usage();
                        return;
                  }
         ...
         System.out.println("\u005cnJava Code Sniffer Version 1.0: Java program" +
         " parsed successfully.");
         } catch (ParseException e) {
         System.out.println(e.getMessage());
         System.out.println("\u005cnJava Code Sniffer Version 1.0: Encountered " +
         "errors during parse.");
         }
        }
        private static void usage() {
         System.out.println("Java Code Sniffer Version 1.0: Usage is:");
         System.out.println(" java JavaParser file <option>");
         System.out.println("where option is one of:");
         System.out.println(" C - Display Comments");
         System.out.println(" S - Display String Literals");
         System.out.println(" N - Display Class Names");
        }
